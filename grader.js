...
var loadUrlResource = function(url, checksfile) {
    if (url != null) {
        rest.get(url).on('complete', function(result) {
            if (result instanceof Error) {
                ...
                var checked = checkUrl(result, checksfile);
                var outJson = JSON.stringify(checked, null, 4);
                console.log(outJson);
            }
        });
    }
...
var cheerioUrlFile = function(urlContent) {
